...
const ResetPassword = () => {
  ...
  return (
    <div className='w-screen overflow-x-hidden flex items-center justify-center min-h-screen bg-gradient-to-br from-red-400 to-purple-500'>

      <img onClick={()=>navigate('/home-login')} src={assets.logo} alt="" className='absolute left-5 sm:left-20 top-5 w-28 sm:w-32 cursor-pointer'/>
      ...
      {isOtpSubmitted && isEmailSent &&
        <form onSubmit={onSubmitNewPassowrd} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'> 
